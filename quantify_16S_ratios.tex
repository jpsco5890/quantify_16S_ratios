...
\begin{table}[h]
  \begin{tabular}{|l|c|}
    ...
    ddH$_2$O & \texttt{20.8} \\
    \hline
    5X high-fidelity (HF) reaction buffer & \texttt{8.0} \\
    \hline
    dNTPs & \texttt{0.8}\\
    \hline
    3 $\mu$M 27F forward primer & \texttt{4.0} \\
    \hline
    3 $\mu$M 1492R reverse primer & \texttt{4.0} \\
    \hline
    Phusion polymerase & \texttt{0.4} \\
    \hline
    template gDNA & \texttt{2.0} \\
    \hline
    Total & \texttt{40.0} \\
    \hline
  \end{tabular}
